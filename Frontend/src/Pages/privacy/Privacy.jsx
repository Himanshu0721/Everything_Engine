...
const Privacy = () => {
    ...
    return (
        <div className="privacy-container p-6 text-gray-800 w-[85%]">
            <h1 className="text-2xl font-bold mb-4">Privacy Policy</h1>
      
            <section className="mb-6">
                <h2 className="text-sm sm:text-sm md:text-base lg:text-lg font-semibold mb-2">Introduction</h2>
                <p>
            ...
            <section className="mb-6">
                <h2 className="text-sm sm:text-sm md:text-base lg:text-lg font-semibold mb-2">Acceptance of Terms</h2>
                <p>
            ...
            <section className="mb-6">
                <h2 className="text-sm sm:text-sm md:text-base lg:text-lg font-semibold mb-2">Intellectual Property Rights</h2>
                <p>
            ...
            <section className="mb-6">
                <h2 className="text-sm sm:text-sm md:text-base lg:text-lg font-semibold mb-2">Third-Party Links</h2>
                <p>
            ...
            <section className="mb-6">
                <h2 className="text-sm sm:text-sm md:text-base lg:text-lg font-semibold mb-2">Contact Information</h2>
                <p>
