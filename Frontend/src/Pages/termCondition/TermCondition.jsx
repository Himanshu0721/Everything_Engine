    ...
    return (
        <div className="terms-container p-6 text-gray-800 w-[85%]">
            ...
            <p className="mb-4 text-gray-600">
                Welcome to{" "}<span className="font-semibold text-gray-700">The Entrepreneurship Network {" "} ("TEN")</span>. By using our platform and services, you agree to abide by the following terms and conditions ("Terms").
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">1. A Platform for Empowerment</h2>
            <p className="mb-4 text-gray-600">
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">2. Age Requirements</h2>
            <p className="mb-4 text-gray-600">
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">3. Your Content and Contributions</h2>
            <p className="mb-4 text-gray-600">
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">4. Privacy</h2>
            <p className="mb-4 text-gray-600">
                TEN respects your privacy and handles your data as outlined in our{" "}  <a href="privacy-policy" className="text-blue-600">Privacy-Policy</a>. We collect and use personal information to improve the platform and its services.
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">5. Disclaimers and Limitation of Liability</h2>
            <p className="mb-4 text-gray-600">
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-3 text-gray-700">6. Termination</h2>
            <p className="mb-4 text-gray-600">
