  ...
  return (
    <HelpCenterLayout>
        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">Creator Monetization</span>
            </div>
          </nav>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <h1 className="text-3xl font-bold mb-8">Creator Monetization</h1>

        {/* FAQs Section */}
        <div className="mb-12">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">FAQs</h2>
          <Link
            to="/help-center/creator-monetization/faqs"
