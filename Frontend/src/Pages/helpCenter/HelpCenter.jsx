    ...
    <HelpCenterLayout>
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Search"
              className="w-full px-4 py-3 pl-12 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <Search
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <h3 className="text-blue-600 text-lg font-medium text-center">
              General
            </h3>
          </Link>
          <Link
