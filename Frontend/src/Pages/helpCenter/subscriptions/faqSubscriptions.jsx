  ...
  return (
    <HelpCenterLayout>
      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        ...
        <div className="text-sm text-gray-600 mb-8">14 days ago · Updated</div>
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-lg">On Android:</p>
            <ol class="list-decimal pl-6 mb-4">
              <li style={{ marginBottom: "8px" }}>
                After signing in, tap on the hamburger icon on the top left of
                the screen to open the app sidebar, then tap on “Subscribe”.
          ...
          <section>
            ...
            <p className="text-lg">To upgrade on the same platform:</p>
            <ol class="list-decimal pl-6 mb-4">
              <li style={{ marginBottom: "8px" }}>
            ...
            <p className="text-lg">To upgrade on a different platform:</p>
            <ol class="list-decimal pl-6 mb-4">
              <li style={{ marginBottom: "8px" }}>
            ...
            <table class="w-full border-collapse">
              <thead>
                <tr class="border-b-2 border-gray-200">
                  <th class="px-8 py-5 text-left text-base font-semibold text-gray-800">
                    Region
                  </th>
                  <th class="px-8 py-5 text-center text-base font-semibold text-gray-800">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr class="hover:bg-gray-50">
                  <td class="px-8 py-6 text-left text-gray-700">Albania</td>
                  <td class="px-8 py-6 text-center text-gray-700"></td>
                  <td class="px-8 py-6 text-center text-gray-700">Yes</td>
                  <td class="px-8 py-6 text-center text-gray-700">Yes</td>
                </tr>
                <tr class="hover:bg-gray-50">
