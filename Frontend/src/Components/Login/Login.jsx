...
const Login = () => {
  ...
  return (
    <div className="login-container">
      ...
      <div className="text">
        <p>
          Talk to the best AI models like ChatGPT, GPT-4, Claude 3.5 Sonnet, FLUX1.1,
          and millions of others - all on Poe.
        </p>
      </div>
      ...
      <p className="terms">
        By continuing, you are agreeing to Ten Everything <a href="#terms">Terms of Service</a> and <a href="#privacy">Privacy Policy</a>.
      </p>
      <hr />
